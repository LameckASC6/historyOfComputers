    ...
    for (const enemy of enemies) {
        if (playerHitTest.toObject(enemy)) {
            if (playerHitTest.toObject(firstCar)) {
                if (randomNum == 1 && hit == true) {
                    hit = false;
                    score += 10;
                    setTimeout(question, 4000);
                } else if(randomNum != 1 && lose==true){
                    let msg = confirm('Play Again?');
                    if (msg == true) {
            ...
            if (playerHitTest.toObject(secondCar)) {
                if (randomNum == 2 && hit == true) {
                    hit = false;
                    score += 10;
                    setTimeout(question, 4000);
                    
                } else if(randomNum != 2 && lose==true){
                    let msg = confirm('Play Again?');
                    if (msg == true) {
                        window.location.reload('false');
                    } else if (msg == false) {
            ...
            if (playerHitTest.toObject(thirdCar)) {
                if (randomNum == 3 && hit == true) {
                    hit = false;
                    score += 10;
                    setTimeout(question, 4000);
                } else if(randomNum != 3 && lose==true){
                    let msg = confirm('Play Again?');
                    if (msg == true) {
                        window.location.reload('false');
                    } else if (msg == false) {
