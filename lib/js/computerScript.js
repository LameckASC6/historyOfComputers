...
let fourteenthCircle = document.getElementById("fourteenthCircle");
let fifteenthCircle = document.getElementById("fifteenthCircle");
let sixteenthCircle = document.getElementById("sixteenthCircle");
...
function visible(item) {
    ...
    fourteenth.style.visibility = "hidden";
    fifteenth.style.visibility = "hidden";
    sixteenth.style.visibility = "hidden";
...
function fourteenthCircleButton() {
    visible(fourteenth);
}

function fifteenthCircleButton() {
    visible(fifteenth);
}

function sixteenthCircleButton() {
    visible(sixteenth);
}
...
fourteenthCircle.addEventListener('mouseover', fourteenthCircleButton);
fifteenthCircle.addEventListener('mouseover', fifteenthCircleButton);
sixteenthCircle.addEventListener('mouseover', sixteenthCircleButton);
